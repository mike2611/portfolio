const projects = {
  albumist: {
    ...
    image_mobile: 'images/projects/albumistMobile.png',
  ...
  stocks: {
    ...
    image_mobile: 'images/projects/stocksMobile.png',
  ...
  lodging: {
    ...
    image_mobile: 'images/projects/lodgingMobile.png',
  ...
  recipe: {
    ...
    image_mobile: 'images/projects/recipeMobile.png',
  ...
  budget: {
    ...
    image_mobile: 'images/projects/budgetMobile.png',
    technologies: ['RoR', 'Devise'],
  ...
  leaderboard: {
    ...
    image_mobile: 'images/projects/leaderboardMobile.png',
    technologies: ['JS', 'Webpack'],
  ...
  user: {
    ...
    image_mobile: 'images/projects/userMobile.png',
  ...
  books: {
    ...
    image_mobile: 'images/projects/booksMobile.png',
  ...
  todo: {
    ...
    image_mobile: 'images/projects/todoMobile.png',
  ...
  calisthenics: {
    ...
    image_mobile: 'images/projects/calisthenicsMobile.png',
    technologies: ['HTML', 'CSS', 'JS'],
  ...
  sketch: {
    ...
    image_mobile: 'images/projects/etchMobile.png',
    technologies: ['HTML', 'CSS', 'JS'],
  ...
  rps: {
    ...
    image_mobile: 'images/projects/rpsMobile.png',
    technologies: ['HTML', 'CSS', 'JS'],
